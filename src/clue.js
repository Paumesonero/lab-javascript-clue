...
function revealMystery(obj) {
  let solvedMistery = pickMystery()
  return `${solvedMistery.suspect.firstName} ${solvedMistery.suspect.lastName} killed Mr.Boddy using the ${solvedMistery.weapon.name} in the ${solvedMistery.room.name}`
}
